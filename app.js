...
function pgAvaliacao(ct) {
  ...
  document.getElementById('btn-calcular').addEventListener('click', function() {
    var av = m.avaliacoes[S.selPeriod];
    console.log('[Calcular] membro:', m.nome, '| periodo:', S.selPeriod);
    console.log('[Calcular] skills:', JSON.stringify(av ? av.skills : null));
    console.log('[Calcular] kpis:', JSON.stringify(av ? av.kpis : null));
    console.log('[Calcular] pres:', JSON.stringify(av ? av.pres : null));
